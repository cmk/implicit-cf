...
alpha = 0.0 -- confidence scaling factor, see Hu et al section 4
...
showMat m = DM.prettyMatrix $ fmap (\f -> (fromInteger $ round $ f * (10^2)) / (10.0^^2)) m
...
errorAt biasModel matrices (user,item,rating) = rating - bias - prediction 
